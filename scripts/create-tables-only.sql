...
DO $$ 
BEGIN
    -- CommunityPostLike 외래키
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'CommunityPostLike_postId_CommunityPost_id_fk') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'CommunityPostLike_userId_User_id_fk') THEN
        ALTER TABLE "CommunityPostLike" 
    ...
    -- CommunityPostDislike 외래키
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'CommunityPostDislike_postId_CommunityPost_id_fk') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'CommunityPostDislike_userId_User_id_fk') THEN
        ALTER TABLE "CommunityPostDislike" 
