              ...
              <>
                ...
                {userRole === 'creator' && (
                  <Button 
                    ...
                    className="bg-coral-500 hover:bg-coral-600 text-white hidden md:flex"
                  >
                ...
                <Button variant="ghost" size="sm" className="relative">
                  ...
                  <Badge className="absolute -top-1 -right-1 w-5 h-5 p-0 flex items-center justify-center bg-coral-500 text-white text-xs">
                    3
                  </Badge>
                </Button>
