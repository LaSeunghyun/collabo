...
export default function FulfillmentPage() {
  ...
  const { data, isLoading, error, refetch } = useQuery<FulfillmentResponse>({
    ...
    queryFn: async () => {
      ...
      if (!response.ok) {
        throw new Error('이행 현황을 불러올 수 없습니다.');
      }
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">이행 현황을 불러오는 중 오류가 발생했습니다.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">리워드 이행 관리</h1>
        <p className="text-gray-600">
          배송 및 티켓 이행 현황을 확인하고 관리하세요.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Select value={filters.type} onValueChange={(value) => handleFilterChange('type', value)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="shipment">배송</SelectItem>
              ...
              <Card key={shipment.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                      <div className="text-sm text-gray-600">운송장번호</div>
            ...
            {data?.tickets.map((ticket) => (
              <Card key={ticket.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                      <div className="text-sm text-gray-600">이벤트 날짜</div>
