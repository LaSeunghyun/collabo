...
// export const \w+Relations = relations(users, ({ many, one }) => ({
...
// export const \w+Relations = relations(projects, ({ many, one }) => ({
  owner: one(users, {
...
// export const \w+Relations = relations(partners, ({ one, many }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(partnerMatches, ({ one }) => ({
  project: one(projects, {
...
// export const \w+Relations = relations(authDevices, ({ one, many }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(authSessions, ({ one, many }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(refreshTokens, ({ one }) => ({
...
// export const \w+Relations = relations(fundings, ({ one }) => ({
  project: one(projects, {
...
// export const \w+Relations = relations(settlements, ({ one, many }) => ({
  project: one(projects, {
...
// export const \w+Relations = relations(products, ({ one, many }) => ({
  project: one(projects, {
...
// export const \w+Relations = relations(orders, ({ one, many }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(orderItems, ({ one }) => ({
  order: one(orders, {
...
// export const \w+Relations = relations(posts, ({ one, many }) => ({
  project: one(projects, {
...
// export const \w+Relations = relations(comments, ({ one, many }) => ({
  post: one(posts, {
...
// export const \w+Relations = relations(postLikes, ({ one }) => ({
  post: one(posts, {
...
// export const \w+Relations = relations(postDislikes, ({ one }) => ({
  post: one(posts, {
...
// export const \w+Relations = relations(notifications, ({ one }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(visitLogs, ({ one }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(wallets, ({ one }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(auditLogs, ({ one }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(permissions, ({ many }) => ({
  users: many(userPermissions),
}));

// export const \w+Relations = relations(userPermissions, ({ one }) => ({
  user: one(users, {
...
// export const \w+Relations = relations(userFollows, ({ one }) => ({
  follower: one(users, {
...
// export const \w+Relations = relations(commentReactions, ({ one }) => ({
...
// export const \w+Relations = relations(userBlocks, ({ one }) => ({
  blocker: one(users, {
